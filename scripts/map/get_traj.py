map_id = {
    ...
    (309, 315): [(0.5,0,0),(0.9,0.4,1.55),(0.9,0.9,1.55)],
    
    (310, 325): [(0.6,-0.45,-1.55)],
    (310, 316): [(0.5,0,0),(0.85,0.4,1.55)],

    (311, 316): [(0.5,0,0),(0.85,0.4,1.55)],
    ...
    (317, 330): [(0.3,0,0),(0.63, 0.35,1.5)],

    (318, 330): [(0.1,0,0)],
    (318, 309): [(0.4,0,0),(0.9,0.6,1.57)],
    (318, 308): [(0.7,0,0),(1.2,0.6,1.57)],
    (318, 307): [(1.0,0.1,0),(1.7,0.6,1.57)],

    (319, 330): [(0.3,0,0),(0.63, 0.35,1.5)],
    (319, 314): [(0.4,-0.4,-1.55)],

    (332, 318): [(0.45,-0.35,-1.57)],
 
    (321, 314): [(1.7,0,0)],
    (321, 307): [(0.4,-0.4,-1.55)],
    (321, 308): [(0.3,0,0),(0.7,-0.4,-1.55)],
    ...
    (333, 312): [(0.5,0,0)],
    (330, 305): [(0.6,0,0),(1,0.4,1.5),(1,0.7,1.5)],
